...
const description = "Explore 98 field photos documenting Project Wildfire from breaking ground through its outdoor fireplace, patio, lounge, upper deck, and first wood fire.";
